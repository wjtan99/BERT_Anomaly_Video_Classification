...
parser.add_argument('--workers', default=6, help='number of workers in dataloader')
parser.add_argument('--model-name', default='rtfm-bert', help='name to save model')
parser.add_argument('--pretrained', default=None, help='ckpt for pretrained model')
...
parser.add_argument('-r', '--resume', dest='resume', action='store_true',help='resume training')

parser.add_argument('--beta', type=float, default=0.5, help='beta for loss_cls and loss_cls2 (default: 0.5)')
