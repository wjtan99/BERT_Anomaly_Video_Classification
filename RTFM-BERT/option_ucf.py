...
parser.add_argument('--pretrained-ckpt', default='ckpt/ucf-i3d-ckpt.pkl', help='ckpt for pretrained model')
parser.add_argument('--num-classes', type=int, default=13, help='number of class')
...
#parser.add_argument('--test', default=0, type=int, choices=[0], help='test')
